...
import { 
  ...
  ExternalLink, Star, Globe, User, Clock, Check, QrCode, Share2 
} from 'lucide-react';
...
export function PasswordCard({ entry, onEdit, onDelete, onToggleFavorite, onCopy }: PasswordCardProps) {
  ...
  const strengthColors = {
    weak: 'bg-destructive text-destructive-foreground',
