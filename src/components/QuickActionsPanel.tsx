import { Plus, Upload, Cloud, Shield, History, Star, AlertTriangle, Folder } from 'lucide-react';
      ...
      <div className="mt-6 p-4 rounded-xl bg-primary/5 border border-primary/20">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <Button variant="link" size="sm" className="px-0 h-auto mt-2 text-primary">
              Sign in to sync →
            </Button>
          </div>
        </div>
